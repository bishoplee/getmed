...
(function(global, factory) {
    ...
    function scrollPage(section, callback, isMovementUp) {
        ...
        if (getOptions().autoScrolling && getOptions().continuousVertical && typeof v.isMovementUp !== "undefined" && (!v.isMovementUp && v.yMovement == 'up' || v.isMovementUp && v.yMovement == 'down')) {
    ...
    var scrollOverflowHandler = {
        ...
        isScrolled: function isScrolled(direction, el) {
            ...
            if (!getOptions().scrollOverflow || !hasClass(scrollableItem, OVERFLOW) || hasClass(el, 'fp-noscroll') || hasClass(getSlideOrSection(el), 'fp-noscroll')) {
                return true;
            }
    ...
    function addMouseWheelHandler() {
        ...
        var support = 'onwheel'in doc.createElement('div') ? 'wheel' : doc.onmousewheel !== undefined ? 'mousewheel' : 'DOMMouseScroll';
